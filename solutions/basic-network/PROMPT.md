...
- Requests to Google Cloud APis on Workstation instance should not go over the public Internet (use trace route storage.googleapis.com to check).

## Ask

Could you generate the list of gcloud commands needed to achieve the Task and also for test as per Acceptance criteria?
